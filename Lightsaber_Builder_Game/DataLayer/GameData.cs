    ...
    public static class GameData
    {
        ...
        public static List<GameItemModel> StandardGameItems()
        {
            return new List<GameItemModel>()
            {
                ...
                new Weapons(40, "Blaster", 500, 100, 400, "A blaster where if used correctly, can be deadly", false),
                new Weapons(41, "Lightsaber", 1000000, 100, 10000, "The lightsaber is a great weapon that can cut through most things in the universe", false)
            };
        }
    }
}
